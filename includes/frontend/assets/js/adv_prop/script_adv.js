jQuery( document ).ready( function( $ ) {
	...
	*/
	var mxzsm_app = {
		...
		// regions
		'regions_select' 	: 	$( '#mxzsm_regions_adv_prop' ),

		// cities
		'cities_select_wrap': 	$( '.mxzsm_cities' ),
		'cities_select' 	: 	$( '#mxzsm_cities_adv_prop' ),
		...
		'search_button'		: $( '#mx_znayty_submit_button_adv_prop' )
	}; 
	...
	function mxzsm_check_js_obj_of_cities_adv( region_id ) {
		...
		function mxzsm_get_obj_of_cities_database_adv( region_id ) {
			...
			var data = {
				...
				'action'			:  'mxzsm_get_cities_front_adv_prop',
	...
	*/		
		...
		// change social
		$( '#mxzsm_add_prop_social' ).on( 'change', function() {
		...
		// submit form
		$( '#mxzsm_add_prop' ).on( 'submit', function( e ) {
			...
			var form_data = {
				action: 	'mxzsm_add_obj_front_adv_prop',

				title: 		$( '#mxzsm_add_obj_title' ).val(),
				content: 	content,
				region_id: 	$( '#mxzsm_regions_adv_prop' ).val(),
				city_id: 	$( '#mxzsm_cities_adv_prop' ).val(),
				...
				// social
				obj_social: $( '#mxzsm_add_prop_social' ).val(),

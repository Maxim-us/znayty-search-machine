...
class MXZSM_Shortcodes_Search_Form_Adv_Prop
{

	public static function add_shorcode() {

		// search form
		add_shortcode( 'mxzsm_search_form_adv_prop', array( 'MXZSM_Shortcodes_Search_Form_Adv_Prop', 'search_form' ) );
		...
		public static function search_form( $atts ) {
			...
			ob_start();
				...
				$available_region_ids = mxzsm_get_available_regions_adv_prop();
			...
			?>
				...
				<div class="mx-search-by-cities bg-light p-5">
					...
					<div class="mxzsm_regions">
						...
						<select name="mxzsm_regions" id="mxzsm_regions_adv_prop" required="required">
					...
					<div class="mxzsm_cities" <?php echo count( $cities ) == 0 ? 'style="display: none;"' : ''; ?>>
						...
						<select name="mxzsm_cities" id="mxzsm_cities_adv_prop">
					...
					<div class="mx-znayty-submit-button-wrap" <?php echo $region == NULL ? 'style="display: none;"' : ''; ?>>
						...
						<?php if( isset( $atts['search_result_slug'] ) ) : ?>
							...
							<button id="mx_znayty_submit_button_adv_prop" data-search-result-slug="<?php echo $atts['search_result_slug']; ?>">Знайти</button>

						<?php else : ?>

							<button id="mx_znayty_submit_button_adv_prop">Знайти</button>

...
class MXZSM_Shortcodes_Display_Adv_Prop
{
	...
	static public function add_adv_shorcode()
	{
		...
		// 
		add_shortcode( 'mxzsm_advertisement_display_prop', array( 'MXZSM_Shortcodes_Display_Adv_Prop', 'mxzsm_advertisement_display' ) );
			...
			<div class="mx-advertisement-wrap">
				...
				if( $result_adv->have_posts() ) : ?>
					...
					<div class="mx-search-result-wrap_add">
						...
						<!-- system results ... -->
						<?php MXZSM_Shortcodes_Display_Adv_Prop::adv_search_system_info( array(
						...
						<div class="adv_search_result_items_wrap">			
							...
							<?php while( $result_adv->have_posts() ) : $result_adv->the_post(); ?>
								...
								<?php MXZSM_Shortcodes_Display_Adv_Prop::adv_search_result_item(); ?>
					...
					<!-- pagination ... -->
					<?php mxzsm_navigation( 'mxzsm_adv_prop', $posts_per_page, $meta_query, $tax_query ); ?>
					<!-- ... pagination -->
			...
			<div class="mx-adv_search_result_item">
				...
				<div>
					...
					<div class="mx-adv_search_result_item_cat">
						...
						<?php $categories = get_the_terms( get_the_ID(), 'mxzsm_adv_category_prop' ); ?> 
					...
					<div class="mx-adv_search_result_item_region_wrap">
						...
						<?php
							$region_data = mxzsm_get_region_by_post_id_adv_prop( get_the_ID() );	

							$city_data = mxzsm_get_city_by_post_id_adv_prop( get_the_ID() );

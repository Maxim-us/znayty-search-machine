...
class MXZSM_Model
{
	...
	* Table name
	*/
	protected $table = MXZSM_TABLE_SLUG;
	...
	*/
	public function mxzsm_get_row( $table = NULL, $wher_name, $wher_value )
	{
	...
	*/
	public function mxzsm_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
